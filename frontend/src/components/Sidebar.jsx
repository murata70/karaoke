...
function Sidebar({ activeTab, setActiveTab, onLogout, isSidebarOpen, setSidebarOpen }) {
  ...
  const navItemStyle = (id) => ({
    ...
    alignItems: 'center',
    gap: '12px',
    padding: isSidebarOpen ? '12px 24px' : '12px 28px',
    cursor: 'pointer',
  ...
  return (
    <div style={sidebarStyle}>
      <div style={{ padding: isSidebarOpen ? '30px 24px' : '30px 28px', display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      <button 
        ...
        style={{
          ...
          zIndex: 100 // 確実にボタンが最前面に来るように数値を上げました
        }}
      >
